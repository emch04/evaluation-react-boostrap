      ...
      */}
      <div className="footer-section">
        ...
        {/* 
          ...
          Chaque lien est une balise `<a>` contenant une icône SVG.
          - `href` : Mettez l'URL de votre profil.
          - `target="_blank"` et `rel="noopener noreferrer"` : Pour ouvrir le lien dans un nouvel onglet de manière sécurisée.
        */}
        <div className="socials">
          <a href="https://github.com/emch04" title="Voir mon Github">
            <svg
      ...
      {/* 
        ...
        Cette section contient les mêmes liens que votre barre de navigation principale.
      */}
      <div className="footer-section">
        <h4>Liens utiles</h4>
        <ul>
      ...
      {/* 
        SECTION 3 : DERNIÈRES RÉALISATIONS
      */}
      <div className="footer-section">
        <h4>Mes dernières réalisations</h4>
        <ul>
          <li>
            <Link to="/portfolio#fresh-food">Fresh Food</Link>
          </li>
          <li>
            <Link to="/portfolio#restaurant-akira">Restaurant Akira</Link>
          </li>
          <li>
            <Link to="/portfolio#espace-bien-etre">Espace bien-être</Link>
          </li>
          <li>
            <Link to="/portfolio#seo">SEO</Link>
          </li>
          <li>
            <Link to="/portfolio#api">Création d’une API</Link>
          </li>
        </ul>
      </div>
    </footer>
